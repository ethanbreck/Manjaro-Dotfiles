...
function exists(url){scripts=document.getElementsByTagName("script");for(var i=0;i<scripts.length;i++){scr=scripts[i];if(scr.src==url&&url=="//d2ok2u3bz752mp.cloudfront.net/prod/1.15.0/"+"js/localization.js")
return true;}
return false;}
