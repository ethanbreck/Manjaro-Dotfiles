...
"resource": {
  ...
  "tags":[{
      ...
      "vtp_eventCategory":"button-click-paypal",
      ...
      "vtp_nonInteraction":false,
      "vtp_overrideGaSettings":false,
      "vtp_eventCategory":"button-click-sample-ballot-lookup-continue",
      "vtp_trackType":"TRACK_EVENT",
      "vtp_gaSettings":["macro",4],
      "vtp_enableRecaptchaOption":false,
      "vtp_enableUaRlsa":false,
      ...
      "vtp_nonInteraction":false,
      "vtp_overrideGaSettings":false,
      "vtp_eventCategory":"video-any-webinar",
      "vtp_trackType":"TRACK_EVENT",
      "vtp_gaSettings":["macro",4],
      "vtp_enableRecaptchaOption":false,
      "vtp_enableUaRlsa":false,
      ...
      "vtp_nonInteraction":false,
      "vtp_overrideGaSettings":false,
      "vtp_eventCategory":"link-click-reserve-spot-quarterly-presidential-briefing",
      "vtp_trackType":"TRACK_EVENT",
      "vtp_gaSettings":["macro",4],
      "vtp_enableRecaptchaOption":false,
      "vtp_enableUaRlsa":false,
      ...
      "vtp_nonInteraction":false,
      "vtp_overrideGaSettings":false,
      "vtp_eventCategory":"link-click-facebook",
      "vtp_trackType":"TRACK_EVENT",
      "vtp_gaSettings":["macro",4],
      "vtp_enableRecaptchaOption":false,
      "vtp_enableUaRlsa":false,
      ...
      "vtp_nonInteraction":false,
      "vtp_overrideGaSettings":false,
      "vtp_eventCategory":"link-click-twitter",
      "vtp_trackType":"TRACK_EVENT",
      "vtp_gaSettings":["macro",4],
      "vtp_enableRecaptchaOption":false,
      "vtp_enableUaRlsa":false,
      ...
      "vtp_nonInteraction":false,
      "vtp_overrideGaSettings":false,
      "vtp_eventCategory":"button-click-who-represents-me-continue",
      "vtp_trackType":"TRACK_EVENT",
      "vtp_gaSettings":["macro",4],
      "vtp_enableRecaptchaOption":false,
      "vtp_enableUaRlsa":false,
      ...
      "vtp_uniqueTriggerId":"12674457_7",
      "tag_id":10
    },{
      "function":"__cl",
      "tag_id":11
      ...
      "vtp_uniqueTriggerId":"12674457_10",
      ...
      "vtp_waitForTagsTimeout":"2000",
      "vtp_uniqueTriggerId":"12674457_11",
      "tag_id":13
    },{
      "function":"__lcl",
      "vtp_waitForTags":false,
      "vtp_checkValidation":false,
      "vtp_waitForTagsTimeout":"2000",
      "vtp_uniqueTriggerId":"12674457_12",
      "tag_id":14
    },{
      "function":"__lcl",
      "vtp_waitForTags":false,
      "vtp_checkValidation":false,
      "vtp_waitForTagsTimeout":"2000",
      "vtp_uniqueTriggerId":"12674457_13",
      "tag_id":15
    },{
      "function":"__cl",
      "tag_id":16
  ...
  "predicates":[{
      ...
      "function":"_cn",
      "arg0":["macro",1],
      "arg1":"\/Sample_Ballot_Lookup"
    },{
      "function":"_cn",
      "arg0":["macro",6],
      "arg1":"bp-sbl-button bp-sbl-continue bp-sbl-green bp-sbl-right bp-sbl-continue-full"
    },{
      "function":"_eq",
      "arg0":["macro",2],
      "arg1":"gtm.click"
      ...
      "function":"_cn",
      "arg0":["macro",7],
      "arg1":"https:\/\/ballotpedia.zoom.us\/webinar\/register\/WN_JEsKpQHyRRushzrj44P2gA"
    },{
      "function":"_eq",
      "arg0":["macro",2],
      "arg1":"gtm.linkClick"
      ...
      "function":"_cn",
      "arg0":["macro",7],
      "arg1":"https:\/\/www.facebook.com\/Ballotpedia?ref=br_tf"
    },{
      "function":"_re",
      "arg0":["macro",3],
      "arg1":"(^$|((^|,)12674457_12($|,)))"
      ...
      "function":"_cn",
      "arg0":["macro",7],
      "arg1":"https:\/\/twitter.com\/ballotpedia"
    },{
      "function":"_re",
      "arg0":["macro",3],
      "arg1":"(^$|((^|,)12674457_13($|,)))"
...
return null},Wc=!1;if(F.querySelectorAll)try{var Xc=F.querySelectorAll(":root");Xc&&1==Xc.length&&Xc[0]==F.documentElement&&(Wc=!0)}catch(a){}var Tc=Wc;var kd={},ld=null,md=Math.random();kd.s="GTM-PRFQ44Z";kd.Ob="5e1";kd.Md="";var nd={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},od="www.googletagmanager.com/gtm.js";
var qd=od,rd=null,sd=null,td=null,ud="//www.googletagmanager.com/a?id="+kd.s+"&cv=3",vd={},wd={},xd=function(){var a=ld.sequence||0;ld.sequence=a+1;return a};
...
var Jk=function(a,b,c){function d(){var h=a();f+=e?(Fa()-e)*h.playbackRate/1E3:0;e=Fa()}var e=0,f=0;return{Vb:function(h,k,l){var m=a(),p=m.pe,r=void 0!==l?Math.round(l):void 0!==k?Math.round(m.pe*k):Math.round(m.qg),u=void 0!==k?Math.round(100*k):0>=p?0:Math.round(r/p*100),q=F.hidden?!1:.5<=Bk(c);d();var t=dk(c,"gtm.video",[b]);t["gtm.videoProvider"]="youtube";t["gtm.videoStatus"]=h;t["gtm.videoUrl"]=m.url;t["gtm.videoTitle"]=m.title;t["gtm.videoDuration"]=Math.round(p);t["gtm.videoCurrentTime"]=
Math.round(r);t["gtm.videoElapsedTime"]=Math.round(f);t["gtm.videoPercent"]=u;t["gtm.videoVisible"]=q;Sj(t)},sh:function(){e=Fa()},Lc:function(){d()}}};var Kk=D.clearTimeout,Lk=D.setTimeout,P=function(a,b,c){if(eg()){b&&G(b)}else return kc(a,b,c)},Mk=function(){return D.location.href},Nk=function(a){return ne(pe(a),"fragment")},Ok=function(a){return oe(pe(a))},R=function(a,b){return Zd(a,b||2)},Pk=function(a,b,c){var d;b?(a.eventCallback=b,c&&(a.eventTimeout=c),d=Sj(a)):d=Sj(a);return d},Qk=function(a,b){D[a]=b},S=function(a,b,c){b&&(void 0===D[a]||c&&!D[a])&&(D[a]=
...
X.a.ytl=["google"],function(){function a(){var w=Math.round(1E9*Math.random())+"";return F.getElementById(w)?a():w}function b(w,y){if(!w)return!1;for(var x=0;x<u.length;x++)if(0<=w.indexOf("//"+u[x]+"/"+y))return!0;return!1}function c(w){var y=-1!==w.indexOf("?")?"&":"?";if(-1<w.indexOf("origin="))return w+y+"enablejsapi=1";if(!t){var x=S("document");t=x.location.protocol+"//"+x.location.hostname;x.location.port&&(t+=":"+x.location.port)}return w+y+"enablejsapi=1&origin="+encodeURIComponent(t)}function d(w,
y){var x=w.getAttribute("src");if(b(x,"embed/")){if(0<x.indexOf("enablejsapi=1"))return!0;if(y)return w.setAttribute("src",c(x)),!0}return!1}function e(w,y){if(!w.getAttribute("data-gtm-yt-inspected-"+y.sd)&&(w.setAttribute("data-gtm-yt-inspected-"+y.sd,"true"),d(w,y.we))){w.id||(w.id=a());var x=S("YT"),A=x.get(w.id);A||(A=new x.Player(w.id));var B=h(A,y),z={},E;for(E in B)z.Ya=E,B.hasOwnProperty(z.Ya)&&A.addEventListener(z.Ya,function(H){return function(M){return B[H.Ya](M.data)}}(z)),z={Ya:z.Ya}}}
function f(w){G(function(){function y(){for(var A=x.getElementsByTagName("iframe"),B=A.length,z=0;z<B;z++)e(A[z],w)}var x=S("document");y();pk(y)})}function h(w,y){var x,A;function B(){T=Jk(function(){return{url:U,title:aa,pe:J,qg:w.getCurrentTime(),playbackRate:V}},y.sd,w.getIframe());J=0;aa=U="";V=1;return z}function z(ka){switch(ka){case q.PLAYING:J=Math.round(w.getDuration());U=w.getVideoUrl();if(w.getVideoData){var O=w.getVideoData();aa=O?O.title:""}V=w.getPlaybackRate();y.jg?T.Vb("start"):T.Lc();
L=m(y.jh,y.ih,w.getDuration());return E(ka);default:return z}}function E(){ma=w.getCurrentTime();ua=(new Date).getTime();T.sh();sa();return H}function H(ka){var O;switch(ka){case q.ENDED:return N(ka);case q.PAUSED:O="pause";case q.BUFFERING:var Q=w.getCurrentTime()-ma;O=1<Math.abs(((new Date).getTime()-ua)/1E3*V-Q)?"seek":O||"buffering";w.getCurrentTime()&&(y.ig?T.Vb(O):T.Lc());Z();return M;case q.UNSTARTED:return B(ka);default:return H}}function M(ka){switch(ka){case q.ENDED:return N(ka);case q.PLAYING:return E(ka);
case q.UNSTARTED:return B(ka);default:return M}}function N(){for(;A;){var ka=x;Kk(A);ka()}y.hg&&T.Vb("complete",1);return B(q.UNSTARTED)}function Y(){}function Z(){A&&(Kk(A),A=0,x=Y)}function sa(){if(L.length&&0!==V){var ka=-1,O;do{O=L[0];if(O.Ea>w.getDuration())return;ka=(O.Ea-w.getCurrentTime())/V;if(0>ka&&(L.shift(),0===L.length))return}while(0>ka);x=function(){A=0;x=Y;0<L.length&&L[0].Ea===O.Ea&&(L.shift(),T.Vb("progress",O.Oe,O.Te));sa()};A=Lk(x,1E3*ka)}}var T,L=[],J,U,aa,V,ma,ua,La=B(q.UNSTARTED);
A=0;x=Y;return{onStateChange:function(ka){La=La(ka)},onPlaybackRateChange:function(ka){ma=w.getCurrentTime();ua=(new Date).getTime();T.Lc();V=ka;Z();sa()}}}function k(w){for(var y=w.split(","),x=y.length,A=[],B=0;B<x;B++){var z=parseInt(y[B],10);isNaN(z)||100<z||0>z||A.push(z/100)}A.sort(function(E,H){return E-H});return A}function l(w){for(var y=w.split(","),x=y.length,A=[],B=0;B<x;B++){var z=parseInt(y[B],10);isNaN(z)||0>z||A.push(z)}A.sort(function(E,H){return E-H});return A}function m(w,y,x){var A=
w.map(function(E){return{Ea:E,Te:E,Oe:void 0}});if(!y.length)return A;var B=y.map(function(E){return{Ea:E*x,Te:void 0,Oe:E}});if(!A.length)return B;var z=A.concat(B);z.sort(function(E,H){return E.Ea-H.Ea});return z}function p(w){w.vtp_triggerStartOption?r(w):Kg(function(){r(w)})}function r(w){var y=!!w.vtp_captureStart,x=!!w.vtp_captureComplete,A=!!w.vtp_capturePause,B=k(w.vtp_progressThresholdsPercent+""),z=l(w.vtp_progressThresholdsTimeInSeconds+""),E=!!w.vtp_fixMissingApi;if(y||x||A||B.length||
z.length){var H={jg:y,hg:x,ig:A,ih:B,jh:z,we:E,sd:void 0===w.vtp_uniqueTriggerId?"":w.vtp_uniqueTriggerId},M=S("YT"),N=function(){f(H)};G(w.vtp_gtmOnSuccess);if(M)M.ready&&M.ready(N);else{var Y=S("onYouTubeIframeAPIReady");Qk("onYouTubeIframeAPIReady",function(){Y&&Y();N()});G(function(){for(var Z=S("document"),sa=Z.getElementsByTagName("script"),T=sa.length,L=0;L<T;L++){var J=sa[L].getAttribute("src");if(b(J,"iframe_api")||b(J,"player_api"))return}for(var U=Z.getElementsByTagName("iframe"),aa=U.length,
V=0;V<aa;V++)if(!v&&d(U[V],H.we)){P("https://www.youtube.com/iframe_api");v=!0;break}})}}else G(w.vtp_gtmOnSuccess)}var u=["www.youtube.com","www.youtube-nocookie.com"],q={UNSTARTED:-1,ENDED:0,PLAYING:1,PAUSED:2,BUFFERING:3,CUED:5},t,v=!1;X.__ytl=p;X.__ytl.b="ytl";X.__ytl.g=!0;X.__ytl.priorityOverride=0}();
